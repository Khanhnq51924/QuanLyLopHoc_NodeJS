    ...
    import { loginSchema, registerSchema, registerTeacherSchema } from '../validation/user';
    import { validateRequest } from '../middleware/validateRequest';
    import { dangKy, dangKyGiaoVien, dangNhap, deleteUser, duyetDangKyGV, getAllUsers, getDanhSachDangKyGV, getUserDetail, khoiPhucTaiKhoanTuChoi, updateUserRole } from '../controllers/user';
